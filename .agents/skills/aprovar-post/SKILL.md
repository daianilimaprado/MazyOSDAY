...
Deploy automático (Netlify/Vercel) leva ~1-2 min. Validar que o post está no ar com HTTP 200. Também checar que pelo menos `slide-01.png` está acessível publicamente via URL:
