...
> "Relatório completo em `marketing/campanhas/relatorios/<data>-relatorio.md`. Quer que eu rascunhe um email com o resumo pro cliente?"

Se sim, chamar `/email-profissional` com o resumo executivo.
