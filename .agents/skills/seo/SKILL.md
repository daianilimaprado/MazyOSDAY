...
- **Ferramentas:** Busca web e leitura de URLs (nativas)
...
3. Usar busca web pra cada grupo de termos:
...
2. Pra cada termo, usar busca web e analisar:
...
3. Pra cada concorrente relevante (máx 5-8), analisar:
...
1. **Auditoria GEO:**
   - Buscar os top 10 termos em fontes e diretórios
...
6. **Monitoramento GEO:**
   - A cada 30 dias, testar os top 5 termos nas principais IAs
...
- Toda pesquisa deve ser real (usando busca web), nunca inventar dados de volume ou concorrência
